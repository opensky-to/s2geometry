...
namespace S2Geometry.Tests
{
    ...
    public class S2CellIdTest : GeometryTestCase
    {
        ...
        {
            Assert.IsTrue(level >= id.Level && level < S2CellId.MaxLevel);
        ...
        public void S2CellIdTestBasic()
        {
            ...
            //Assert.IsTrue(id.childBegin().lessThan(id));
            //var childEnd = id.childEnd();
            //var childId = childEnd.id();
            //var id1 = id.id();

            //Assert.IsTrue(id.childEnd().greaterThan(id));
        ...
        public void testContinuity()
        {
            ...
            {
                Assert.IsTrue(id.ToPointRaw().Angle(id.NextWithWrap.ToPointRaw()) <= maxDist);
        ...
        public void testCoverage()
        {
            ...
            for (var i = 0; i < 1000000; ++i)
            {
                ...
                Assert.IsTrue(p.Angle(q) <= maxDist);
            }
        }
        ...
        public void testNeighbors()
        {
            ...
            for (var i = 0; i < 4; ++i)
            {
                Assert.IsTrue(faceNbrs[i].IsFace);
